...
/**
 * Basic typings for flow environements
...
declare module T {
    declare class Application {
        ...
        constructor(ctx?: Element, config?: any): Application;
    ...
    declare class EventEmitter {
        ...
        constructor(sandbox: Sandbox): EventEmitter;
    ...
    declare class Sandbox {
        ...
        constructor(application: Application): Sandbox;
    ...
    declare class Module {
        ...
        constructor(ctx: Element, sandbox: Sandbox): Module;

        start(resolve: (value?: any) => void, reject: (error?: any) => void): void;
        stop(): void;
    }

    declare export function createModule(spec: any): Function;
    declare export function createDecorator(spec: any): Function;
}
